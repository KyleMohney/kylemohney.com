...
const EmailTemplates = {
  ...
  matchAccepted: (options) => {
    ...
    const html = '<!DOCTYPE html>' +
      ...
      '<h1 style="margin: 0; color: #fbf7ec; font-size: 28px; font-weight: 700; letter-spacing: -0.5px;">✓ Connection Accepted!</h1>' +
      '</div>' +
      ...
      '<p style="margin: 0; font-size: 14px; color: #5f7030; font-weight: 500;">💬 You can now start messaging with ' + practitionerName + ' to discuss your wellness goals.</p>' +
      '</div>' +
      '<div style="text-align: center; margin: 32px 0;">' +
      '<a href="https://rootedvitality.com/rooted-vitality/dashboard/client/pages/my-matches.html" style="display: inline-block; background-color: #77883e; color: #fbf7ec; padding: 12px 32px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 15px;">View Your Matches</a>' +
      '</div>' +
  ...
  promotion: (options) => {
    ...
    const html = '<!DOCTYPE html>' +
      ...
      '<div style="max-width: 600px; margin: 0 auto; background-color: #fbf7ec;">' +
      '<div style="background: linear-gradient(135deg, #77883e 0%, #4a8b62 100%); padding: 40px 20px; text-align: center; border-bottom: 4px solid #3a6b4a;">' +
      '<h1 style="margin: 0; color: #fbf7ec; font-size: 28px; font-weight: 700; letter-spacing: -0.5px;">✨ ' + title + '</h1>' +
      '</div>' +
      '<div style="padding: 40px 30px;">' +
  ...
  practitionerNewMatch: (options) => {
    ...
    const html = '<!DOCTYPE html>' +
      ...
      '<div style="max-width: 600px; margin: 0 auto; background-color: #fbf7ec;">' +
      '<div style="background: linear-gradient(135deg, #77883e 0%, #4a8b62 100%); padding: 40px 20px; text-align: center; border-bottom: 4px solid #3a6b4a;">' +
      '<h1 style="margin: 0; color: #fbf7ec; font-size: 28px; font-weight: 700; letter-spacing: -0.5px;">🎯 New Match Request!</h1>' +
      '</div>' +
      '<div style="padding: 40px 30px;">' +
      ...
      '<div style="background-color: #fbf7ec; border-left: 4px solid #77883e; padding: 20px; margin: 24px 0; border-radius: 4px;">' +
      '<p style="margin: 0 0 12px 0; font-size: 14px; color: #5f7030; font-weight: 500;">📊 Match Score: <strong>' + (matchScore || 'N/A') + '</strong></p>' +
